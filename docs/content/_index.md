---
title: "stringdb"
description: "A command line for stringdb."
heroTitle: "stringdb, from the command line"
heroLead: "A command line for stringdb. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
stringdb links <path>           # the pages it links to, each addressable
stringdb serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading stringdb by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address stringdb as
  `stringdb://` URIs and follow links across sites. See
