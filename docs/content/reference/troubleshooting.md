...
Most of these come down to network reality or how stringdb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

stringdb rate-limits like any public site. stringdb already paces
...
Where a surface is gated, stringdb reads a cookie or token you supply
...
`stringdb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what stringdb actually did
