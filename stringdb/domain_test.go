...
// HTTP behaviour is covered in stringdb_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "stringdb://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("stringdb", "about")
	if err != nil || got.String() != "stringdb://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want stringdb://page/about", got.String(), err)
	}
}
